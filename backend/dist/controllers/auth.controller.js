...
exports.adminResetPassword = exports.resetPassword = exports.forgotPassword = exports.changePassword = exports.login = exports.register = void 0;
...
const forgotPassword = async (req, res) => {
    try {
        ...
        await (0, email_1.sendResetEmail)(email, token);
        res.status(200).json({
